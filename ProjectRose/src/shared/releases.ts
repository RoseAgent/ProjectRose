...
export const RELEASES: ReleaseEntry[] = [
  {
    ...
    highlights: [
      ...
      'CLI resumes run in a background terminal — you stay in the view you\'re in, and the terminal replays everything you missed when you open the editor. Terminal sessions now survive leaving the editor view entirely',
